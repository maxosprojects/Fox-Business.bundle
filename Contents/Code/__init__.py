...
def MainMenu():
  ...
  oc.add(SearchDirectoryObject(identifier='com.plexapp.plugins.foxbusiness', title='Search', summary='Search Fox Business Videos', prompt='Search:', thumb=R('search.png')))

  return oc

###################################################################################################
@route('/video/foxbusiness/sections/{type}')
...
###################################################################################################
@route('/video/foxbusiness/content')
...
###################################################################################################
@route('/video/foxbusiness/show/{id}')
...
###################################################################################################
@route('/video/foxbusiness/playlist')
